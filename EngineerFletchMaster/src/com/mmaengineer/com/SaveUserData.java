...
class SaveUserData {
    public static String saveUserDataMethod(String accessKey, String authToken, String scriptName, String username, long startTime, int xpGained, int levelsGained, long fishCaught,
                                            long profit) {
        ...
        try {
            ...
            sb.append("&runtime=" + ((System.currentTimeMillis() / 1000) - startTime));
