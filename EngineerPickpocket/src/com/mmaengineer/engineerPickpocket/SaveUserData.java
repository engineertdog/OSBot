...
class SaveUserData {
    public static String saveUserDataMethod(String accessKey, String authToken, String scriptName, String username, long startTime, int xpGained,
			int levelsGained, int pocketsPicked, int numStunned, int numDeaths, long profit) {
    	...
    	try {
			...
			sb.append("&pocketsPicked=" + pocketsPicked);
			sb.append("&stunned=" + numStunned);
			sb.append("&deaths=" + numDeaths);
