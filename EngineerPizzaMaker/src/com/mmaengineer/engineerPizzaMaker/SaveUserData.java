...
class SaveUserData {
    public static String saveUserDataMethod(String accessKey, String authToken, String scriptName, String username,
    		long startTime, int xpGained, int levelsGained, int pizzasMade, int pizzasCooked, long profit) {
    	...
    	try {
			...
			sb.append("&pizzasMade=" + pizzasMade);
			sb.append("&pizzasCooked=" + pizzasCooked);
