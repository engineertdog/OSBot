...
class SaveUserData {
    public static String saveUserDataMethod(String accessKey, String authToken, String scriptName, String username, long startTime, int xpGained, int levelsGained, int runesCrafted,
			long profit) {
    	...
    	try {
		    ...
		    sb.append("&runesCrafted=" + runesCrafted);
